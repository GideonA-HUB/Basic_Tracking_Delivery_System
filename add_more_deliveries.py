...
def add_more_deliveries():
    print("Adding more sample deliveries...")
    ...
    # Sample deliveries data with unique order numbers
    deliveries_data = [
        {
            'name': 'Alice Johnson',
