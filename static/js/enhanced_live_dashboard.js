/**
 * Enhanced Live Dashboard JavaScript
 * Handles real-time price updates with counting and statistics like CoinMarketCap
 */
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Initializing Enhanced Live Dashboard...');
    window.enhancedLiveDashboard = new EnhancedLiveDashboard();
});

// Cleanup on page unload
window.addEventListener('beforeunload', function() {
    if (window.enhancedLiveDashboard) {
        window.enhancedLiveDashboard.destroy();
    }
});
